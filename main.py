...
NUM_CLASSES_PER_CLIENT = 8

DROPOUT_METHOD = 'FedDroput'
...
for round in range(NUM_ROUNDS):
    ...
    if DROPOUT_METHOD == 'FedDroput' or DROPOUT_METHOD == 'FedRolex':
...
file_name = 'outputs\losses_and_accuracies_' + DROPOUT_METHOD  + '_' + str(NUM_CLASSES_PER_CLIENT) + '_' + str(NUM_EPOCHS_PER_ROUND) + '_' + str(NUM_ROUNDS)

with open(file_name, 'w') as f:
    json.dump(json_data, f)
    
file_name = 'saved_models\model_' + DROPOUT_METHOD  + '_' + str(NUM_CLASSES_PER_CLIENT) + '_' + str(NUM_EPOCHS_PER_ROUND) + '_' + str(NUM_ROUNDS)
